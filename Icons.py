...
class Icons:
    def __init__(self):
        ...
        self.Stop = QIcon("icons/icons8-stop.png")
        self.Loop = QIcon("icons/icons8-repeat.png")
        self.Start = QIcon("icons/icons8-skip-to-start.png")
        self.End = QIcon("icons/icons8-skip-to-end.png")
        self.Next = QIcon("icons/icons8-forward.png")
        self.Back = QIcon("icons/icons8-back.png")
